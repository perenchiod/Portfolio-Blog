<div class="container">
	...
	<textarea name="body" rows="5" class="form-control @if($errors->has('body')) has-error @endif" placeholder="Enter body">@if(isset($post->body)){{$post->body}}@else{{{ Input::old('body')}}}@endif</textarea>
